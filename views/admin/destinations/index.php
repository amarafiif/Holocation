...
<body>
    ...
    <div class="antialiased bg-indigo-100">
        ...
        <main class="p-4 md:ml-64 min-h-screen pt-24">
            ...
            <div class="pt-5 bg-white h-auto pb-5 mb-4">
                <a href="createDestinationForm.php" class="bg-indigo-500 text-sm text-white font-bold px-5 py-2.5">Add Destination</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="border-b">
                                    ...
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-600 whitespace-nowrap"><?php echo $row['location'] ?></td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-600 whitespace-nowrap">
                                        ...
                                        <div class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow rounded-xl" id="dropdownAction<?= $row['id'] ?>">
                                            <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                                                <li>
                                                    <a href="detailDestination.php?id=<?php echo $row['id']; ?>" class="flex py-3 px-4 content-center text-sm hover:text-indigo-600">Detail & Edit</a>
                                                </li>
